...
#define CONTROL_BITS_DATAIN_DATA     32
#define CONTROL_ADDR_ADDRESS_DATA    0x18
#define CONTROL_BITS_ADDRESS_DATA    32
#define CONTROL_ADDR_DATAOUTPUT_DATA 0x20
#define CONTROL_BITS_DATAOUTPUT_DATA 32
#define CONTROL_ADDR_DATAOUTPUT_CTRL 0x24
#define CONTROL_ADDR_RAMSEL_DATA     0x28
#define CONTROL_BITS_RAMSEL_DATA     32
#define CONTROL_ADDR_OP_DATA         0x38
#define CONTROL_BITS_OP_DATA         32
#define CONTROL_ADDR_MODINDEX_DATA   0x40
#define CONTROL_BITS_MODINDEX_DATA   32
#define CONTROL_ADDR_TWIDDLEIN_BASE  0x30
#define CONTROL_ADDR_TWIDDLEIN_HIGH  0x37
#define CONTROL_WIDTH_TWIDDLEIN      32
#define CONTROL_DEPTH_TWIDDLEIN      2
