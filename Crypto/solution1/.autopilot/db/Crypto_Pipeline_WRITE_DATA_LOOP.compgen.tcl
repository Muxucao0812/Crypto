...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename DataIn \
    op interface \
    ports { DataIn_address0 { O 12 vector } DataIn_ce0 { O 1 bit } DataIn_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'DataIn'"
}
}
