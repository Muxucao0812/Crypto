...
set C_modelArgList {
	{ trunc_ln16 int 6 regular  }
	{ shl_cast_mid2 int 6 regular  }
	{ mul_ln296 int 10 regular  }
	{ ReadAddr int 10 regular {array 64 { 0 3 } 0 1 }  }
	{ sub_ln300 int 41 regular  }
	...
	{ select_ln291_1 int 1 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "trunc_ln16", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "shl_cast_mid2", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln296", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "ReadAddr", "interface" : "memory", "bitwidth" : 10, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sub_ln300", "interface" : "wire", "bitwidth" : 41, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_263", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "select_ln291_1", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ trunc_ln16 sc_in sc_lv 6 signal 0 } 
	{ shl_cast_mid2 sc_in sc_lv 6 signal 1 } 
	{ mul_ln296 sc_in sc_lv 10 signal 2 } 
	...
	{ sub_ln300 sc_in sc_lv 41 signal 4 } 
	...
	{ tmp_263 sc_in sc_lv 10 signal 13 } 
	...
	{ select_ln291_1 sc_in sc_lv 1 signal 18 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln16", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "trunc_ln16", "role": "default" }} , 
 	{ "name": "shl_cast_mid2", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "shl_cast_mid2", "role": "default" }} , 
 	{ "name": "mul_ln296", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mul_ln296", "role": "default" }} , 
 	...
 	{ "name": "sub_ln300", "direction": "in", "datatype": "sc_lv", "bitwidth":41, "type": "signal", "bundle":{"name": "sub_ln300", "role": "default" }} , 
 	...
 	{ "name": "tmp_263", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "tmp_263", "role": "default" }} , 
 	...
 	{ "name": "select_ln291_1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "select_ln291_1", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U206", "Parent" : "0"},
...
set Spec2ImplPortList { 
	trunc_ln16 { ap_none {  { trunc_ln16 in_data 0 6 } } }
	shl_cast_mid2 { ap_none {  { shl_cast_mid2 in_data 0 6 } } }
	mul_ln296 { ap_none {  { mul_ln296 in_data 0 10 } } }
	...
	sub_ln300 { ap_none {  { sub_ln300 in_data 0 41 } } }
	...
	tmp_263 { ap_none {  { tmp_263 in_data 0 10 } } }
	...
	select_ln291_1 { ap_none {  { select_ln291_1 in_data 0 1 } } }
}
