set moduleName Crypto1_Pipeline_WRITE_DATA_ROW_LOOP_WRITE_DATA_COL_LOOP2
set isTopModule 0
...
set C_modelName {Crypto1_Pipeline_WRITE_DATA_ROW_LOOP_WRITE_DATA_COL_LOOP2}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln80_1 int 42 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "add_ln80_1", "interface" : "wire", "bitwidth" : 42, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln80_1 sc_in sc_lv 42 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln80_1", "direction": "in", "datatype": "sc_lv", "bitwidth":42, "type": "signal", "bundle":{"name": "add_ln80_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	add_ln80_1 { ap_none {  { add_ln80_1 in_data 0 42 } } }
