...
set C_modelArgList {
	...
	{ select_ln363_2 int 1 regular  }
	{ trunc_ln17 int 6 regular  }
	{ shl765_cast_mid2 int 6 regular  }
	{ mul_ln369 int 10 regular  }
	{ ReadAddr int 10 regular {array 64 { 0 3 } 0 1 }  }
	{ sub_ln372 int 41 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "tmp_264", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "select_ln363_2", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln17", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "shl765_cast_mid2", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln369", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "ReadAddr", "interface" : "memory", "bitwidth" : 10, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sub_ln372", "interface" : "wire", "bitwidth" : 41, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ tmp_264 sc_in sc_lv 10 signal 0 } 
	...
	{ select_ln363_2 sc_in sc_lv 1 signal 13 } 
	{ trunc_ln17 sc_in sc_lv 6 signal 14 } 
	{ shl765_cast_mid2 sc_in sc_lv 6 signal 15 } 
	{ mul_ln369 sc_in sc_lv 10 signal 16 } 
	...
	{ sub_ln372 sc_in sc_lv 41 signal 18 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_264", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "tmp_264", "role": "default" }} , 
 	...
 	{ "name": "select_ln363_2", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "select_ln363_2", "role": "default" }} , 
 	{ "name": "trunc_ln17", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "trunc_ln17", "role": "default" }} , 
 	{ "name": "shl765_cast_mid2", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "shl765_cast_mid2", "role": "default" }} , 
 	{ "name": "mul_ln369", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mul_ln369", "role": "default" }} , 
 	...
 	{ "name": "sub_ln372", "direction": "in", "datatype": "sc_lv", "bitwidth":41, "type": "signal", "bundle":{"name": "sub_ln372", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	tmp_264 { ap_none {  { tmp_264 in_data 0 10 } } }
	...
	select_ln363_2 { ap_none {  { select_ln363_2 in_data 0 1 } } }
	trunc_ln17 { ap_none {  { trunc_ln17 in_data 0 6 } } }
	shl765_cast_mid2 { ap_none {  { shl765_cast_mid2 in_data 0 6 } } }
	mul_ln369 { ap_none {  { mul_ln369 in_data 0 10 } } }
	...
	sub_ln372 { ap_none {  { sub_ln372 in_data 0 41 } } }
}
