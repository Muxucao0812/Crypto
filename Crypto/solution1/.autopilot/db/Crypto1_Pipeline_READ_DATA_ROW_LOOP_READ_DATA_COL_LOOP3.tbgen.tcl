...
set C_modelArgMapList {[ 
	{ "Name" : "add_ln99", "interface" : "wire", "bitwidth" : 42, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln99 sc_in sc_lv 42 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln99", "direction": "in", "datatype": "sc_lv", "bitwidth":42, "type": "signal", "bundle":{"name": "add_ln99", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U529", "Parent" : "0"},
...
set Spec2ImplPortList { 
	add_ln99 { ap_none {  { add_ln99 in_data 0 42 } } }
