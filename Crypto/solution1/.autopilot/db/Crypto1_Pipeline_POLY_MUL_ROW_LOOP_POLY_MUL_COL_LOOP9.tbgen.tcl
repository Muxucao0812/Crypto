set moduleName Crypto1_Pipeline_POLY_MUL_ROW_LOOP_POLY_MUL_COL_LOOP9
set isTopModule 0
...
set C_modelName {Crypto1_Pipeline_POLY_MUL_ROW_LOOP_POLY_MUL_COL_LOOP9}
set C_modelType { void 0 }
set C_modelArgList {
	{ add_ln267 int 42 regular  }
	{ add_ln268 int 42 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "add_ln267", "interface" : "wire", "bitwidth" : 42, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln268", "interface" : "wire", "bitwidth" : 42, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln267 sc_in sc_lv 42 signal 0 } 
	{ add_ln268 sc_in sc_lv 42 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln267", "direction": "in", "datatype": "sc_lv", "bitwidth":42, "type": "signal", "bundle":{"name": "add_ln267", "role": "default" }} , 
 	{ "name": "add_ln268", "direction": "in", "datatype": "sc_lv", "bitwidth":42, "type": "signal", "bundle":{"name": "add_ln268", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U409", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_8_3_32_1_1_U410", "Parent" : "0"},
...
set Spec2ImplPortList { 
	add_ln267 { ap_none {  { add_ln267 in_data 0 42 } } }
	add_ln268 { ap_none {  { add_ln268 in_data 0 42 } } }
