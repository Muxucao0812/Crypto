...
using hls::sim::Byte;
extern "C" void STEPMUL(volatile void *, volatile void *, volatile void *);
extern "C" void apatb_STEPMUL_hw(volatile void * __xlx_apatb_param_input1, volatile void * __xlx_apatb_param_input2, volatile void * __xlx_apatb_param_res) {
using hls::sim::createStream;
  // DUT call
  STEPMUL(__xlx_apatb_param_input1, __xlx_apatb_param_input2, __xlx_apatb_param_res);
}
