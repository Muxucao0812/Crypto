set moduleName apply_bit_reverse
set isTopModule 0
...
set C_modelName {apply_bit_reverse}
set C_modelType { void 0 }
set C_modelArgList {
	{ x int 32 regular {array 4096 { 1 3 } 1 1 }  }
	{ result int 32 regular {array 4096 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ result_address0 sc_out sc_lv 12 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "result", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 12 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 32 } } }
	result { ap_memory {  { result_address0 mem_address 1 12 }  { result_ce0 mem_ce 1 1 }  { result_we0 mem_we 1 1 }  { result_d0 mem_din 1 32 } } }
}
