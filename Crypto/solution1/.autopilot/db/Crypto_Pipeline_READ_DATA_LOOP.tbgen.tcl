set moduleName Crypto_Pipeline_READ_DATA_LOOP
set isTopModule 0
...
set C_modelName {Crypto_Pipeline_READ_DATA_LOOP}
...
set C_modelArgList {
	...
	{ DataIn int 32 regular {array 4096 { 0 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ RAMSel_cast sc_in sc_lv 1 signal 32 } 
	{ DataIn_address0 sc_out sc_lv 12 signal 33 } 
	{ DataIn_ce0 sc_out sc_logic 1 signal 33 } 
	{ DataIn_we0 sc_out sc_logic 1 signal 33 } 
	{ DataIn_d0 sc_out sc_lv 32 signal 33 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_32_1_1_U566", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_32_1_1_U567", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2_1_32_1_1_U568", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	DataIn { ap_memory {  { DataIn_address0 mem_address 1 12 }  { DataIn_ce0 mem_ce 1 1 }  { DataIn_we0 mem_we 1 1 }  { DataIn_d0 mem_din 1 32 } } }
}
