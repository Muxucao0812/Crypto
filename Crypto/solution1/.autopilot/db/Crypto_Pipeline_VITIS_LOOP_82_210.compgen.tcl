...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename DataRAM_2 \
    op interface \
    ports { DataRAM_2_address0 { O 12 vector } DataRAM_2_ce0 { O 1 bit } DataRAM_2_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename DataRAM_5 \
    op interface \
    ports { DataRAM_5_address0 { O 12 vector } DataRAM_5_ce0 { O 1 bit } DataRAM_5_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename DataRAM_8 \
    op interface \
    ports { DataRAM_8_address0 { O 12 vector } DataRAM_8_ce0 { O 1 bit } DataRAM_8_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename DataRAM_11 \
    op interface \
    ports { DataRAM_11_address0 { O 12 vector } DataRAM_11_ce0 { O 1 bit } DataRAM_11_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { DataOutStream_address0 { O 14 vector } DataOutStream_ce0 { O 1 bit } DataOutStream_we0 { O 1 bit } DataOutStream_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'DataOutStream'"
}
}
