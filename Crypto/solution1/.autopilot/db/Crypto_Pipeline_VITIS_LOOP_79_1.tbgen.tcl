set moduleName Crypto_Pipeline_VITIS_LOOP_79_1
set isTopModule 0
...
set C_modelName {Crypto_Pipeline_VITIS_LOOP_79_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln79 int 31 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln79", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln79 sc_in sc_lv 31 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln79", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "zext_ln79", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_32_1_1_U497", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_16_4_32_1_1_U498", "Parent" : "0"},
...
set Spec2ImplPortList { 
	zext_ln79 { ap_none {  { zext_ln79 in_data 0 31 } } }
