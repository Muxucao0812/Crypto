...
module Crypto1_Crypto1_Pipeline_VITIS_LOOP_411_1121 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] NTTData_addr_4_ret_reg_351;
reg   [31:0] NTTData_1_addr_4_ret_reg_356;
reg   [31:0] NTTData_2_addr_4_ret_reg_361;
reg   [31:0] NTTData_3_addr_4_ret_reg_366;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln414_fu_237_p1;
reg   [5:0] global_pair_index_fu_70;
wire   [5:0] add_ln411_fu_217_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_m;
wire   [3:0] lshr_ln414_1_fu_227_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln411_fu_211_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln411_fu_211_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        NTTData_1_addr_reg_321 <= zext_ln414_fu_237_p1;
        NTTData_2_addr_reg_316 <= zext_ln414_fu_237_p1;
        NTTData_3_addr_reg_326 <= zext_ln414_fu_237_p1;
        NTTData_addr_reg_311 <= zext_ln414_fu_237_p1;
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln411_fu_211_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign NTTData_1_d0 = NTTData_1_addr_4_ret_reg_356;

assign NTTData_2_address0 = NTTData_2_addr_reg_316_pp0_iter21_reg;

assign NTTData_2_d0 = NTTData_2_addr_4_ret_reg_361;

assign NTTData_3_address0 = NTTData_3_addr_reg_326_pp0_iter21_reg;

assign NTTData_3_d0 = NTTData_3_addr_4_ret_reg_366;

assign NTTData_address0 = NTTData_addr_reg_311_pp0_iter21_reg;

assign NTTData_d0 = NTTData_addr_4_ret_reg_351;

assign PermuteData_1_address0 = zext_ln414_fu_237_p1;

assign PermuteData_2_address0 = zext_ln414_fu_237_p1;

assign PermuteData_3_address0 = zext_ln414_fu_237_p1;

assign PermuteData_address0 = zext_ln414_fu_237_p1;

assign add_ln411_fu_217_p2 = (ap_sig_allocacmp_m + 6'd1);
...
assign grp_Configurable_PE_2_fu_4743_p_din3 = TwiddleFactor_3;

assign grp_Configurable_PE_2_fu_4743_p_din4 = 2'd1;

assign grp_Configurable_PE_2_fu_4743_p_din5 = 3'd4;
...
assign grp_Configurable_PE_2_fu_4751_p_din3 = TwiddleFactor_3;

assign grp_Configurable_PE_2_fu_4751_p_din4 = 2'd1;

assign grp_Configurable_PE_2_fu_4751_p_din5 = 3'd4;

assign icmp_ln411_fu_211_p2 = ((ap_sig_allocacmp_m == 6'd32) ? 1'b1 : 1'b0);

assign lshr_ln414_1_fu_227_p4 = {{ap_sig_allocacmp_m[4:1]}};

assign zext_ln414_fu_237_p1 = lshr_ln414_1_fu_227_p4;

endmodule //Crypto1_Crypto1_Pipeline_VITIS_LOOP_411_1121
