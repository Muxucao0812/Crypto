...
always @ (posedge ap_clk) begin
    if (((icmp_ln248_fu_145_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        DataRAM_3_addr_reg_205 <= zext_ln248_fu_157_p1;
        DataRAM_6_addr_reg_211 <= zext_ln248_fu_157_p1;
        DataRAM_9_addr_reg_217 <= zext_ln248_fu_157_p1;
        DataRAM_addr_reg_199 <= zext_ln248_fu_157_p1;
    end
end
...
assign icmp_ln248_fu_145_p2 = ((ap_sig_allocacmp_j_20 == 13'd4096) ? 1'b1 : 1'b0);

assign zext_ln248_fu_157_p1 = ap_sig_allocacmp_j_20;
