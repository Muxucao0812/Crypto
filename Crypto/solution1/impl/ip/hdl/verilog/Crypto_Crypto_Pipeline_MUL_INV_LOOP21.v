...
always @ (posedge ap_clk) begin
    if (((icmp_ln253_fu_145_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        DataRAM_10_addr_reg_217 <= zext_ln253_fu_157_p1;
        DataRAM_1_addr_reg_199 <= zext_ln253_fu_157_p1;
        DataRAM_4_addr_reg_205 <= zext_ln253_fu_157_p1;
        DataRAM_7_addr_reg_211 <= zext_ln253_fu_157_p1;
    end
end
...
assign grp_MUL_MOD_fu_1763_p_ce = grp_MUL_MOD_fu_128_ap_ce;

assign grp_MUL_MOD_fu_1763_p_din1 = MulInvInput_reg_223;

assign grp_MUL_MOD_fu_1763_p_din2 = 32'd1073553391;

assign grp_MUL_MOD_fu_1763_p_din3 = 2'd1;

assign icmp_ln253_fu_145_p2 = ((ap_sig_allocacmp_j_19 == 13'd4096) ? 1'b1 : 1'b0);

assign zext_ln253_fu_157_p1 = ap_sig_allocacmp_j_19;
