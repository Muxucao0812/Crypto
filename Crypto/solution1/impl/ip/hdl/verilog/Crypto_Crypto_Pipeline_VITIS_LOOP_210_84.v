...
module Crypto_Crypto_Pipeline_VITIS_LOOP_210_84 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((icmp_ln210_fu_125_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        DataRAM_11_addr_reg_186 <= zext_ln210_fu_137_p1;
        DataRAM_2_addr_reg_171 <= zext_ln210_fu_137_p1;
        DataRAM_5_addr_reg_176 <= zext_ln210_fu_137_p1;
        DataRAM_8_addr_reg_181 <= zext_ln210_fu_137_p1;
    end
end
...
assign BitReverseData_2_address0 = zext_ln210_fu_137_p1;
...
assign add_ln210_fu_131_p2 = (ap_sig_allocacmp_j_8 + 13'd1);
...
assign icmp_ln210_fu_125_p2 = ((ap_sig_allocacmp_j_8 == 13'd4096) ? 1'b1 : 1'b0);

assign zext_ln210_fu_137_p1 = ap_sig_allocacmp_j_8;

endmodule //Crypto_Crypto_Pipeline_VITIS_LOOP_210_84
