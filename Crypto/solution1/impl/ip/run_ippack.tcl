...
set Interfaces {
    s_axi_control {
        ...
        memories "NTTTwiddleIn {base_address 32768 range 32768} DataIn {base_address 65536 range 65536} INTTTwiddleIn {base_address 131072 range 32768}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
