...
set Interfaces {
    s_axi_control {
        ...
        memories "NTTTwiddleIn {base_address 32768 range 32768} INTTTwiddleIn {base_address 65536 range 32768}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_control dataInStream dataOutStream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
