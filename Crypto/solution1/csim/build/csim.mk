...
HLS_SOURCES = ../../../../main_TB.cpp ../../../../pow_mod.cpp ../../../../Utils.cpp ../../../../AddressGen_TB.cpp ../../../../AddressGen.cpp ../../../../Crypto_TB.cpp ../../../../Arithmetic.cpp ../../../../PE_UNIT.cpp ../../../../PE_ARRAY.cpp ../../../../DATAMemory.cpp ../../../../Crypto1.cpp ../../../../Crypto.cpp ../../../../TwiddleMemory.cpp
...
$(ObjDir)/Crypto1.o: ../../../../Crypto1.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Crypto1.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Crypto1.d
