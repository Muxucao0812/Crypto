...
module Crypto1_Crypto1_Pipeline_VITIS_LOOP_386_724 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [3:0] lshr_ln386_2_reg_282;
reg   [3:0] lshr_ln386_2_reg_282_pp0_iter1_reg;
reg   [3:0] lshr_ln386_2_reg_282_pp0_iter2_reg;
wire   [1:0] trunc_ln388_fu_225_p1;
reg   [1:0] trunc_ln388_reg_292;
wire   [31:0] tmp_16_fu_247_p6;
reg   [31:0] tmp_16_reg_317;
wire   [63:0] l_12_cast89_fu_201_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln388_fu_239_p1;
wire   [63:0] zext_ln386_fu_260_p1;
reg   [6:0] l_fu_60;
wire   [6:0] add_ln386_fu_195_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_l_4;
wire   [3:0] lshr_ln388_2_fu_229_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln386_fu_189_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln386_2_reg_282_pp0_iter1_reg <= lshr_ln386_2_reg_282;
        trunc_ln388_reg_292 <= trunc_ln388_fu_225_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln386_fu_189_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        empty_reg_278 <= empty_fu_206_p1;
        lshr_ln386_2_reg_282 <= {{ap_sig_allocacmp_l_4[5:2]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        lshr_ln386_2_reg_282_pp0_iter2_reg <= lshr_ln386_2_reg_282_pp0_iter1_reg;
        tmp_16_reg_317 <= tmp_16_fu_247_p6;
    end
end
...
always @ (*) begin
    if (((icmp_ln386_fu_189_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign InputIndex_address0 = l_12_cast89_fu_201_p1;

assign PermuteData_1_address0 = zext_ln386_fu_260_p1;

assign PermuteData_1_d0 = tmp_16_reg_317;

assign PermuteData_2_address0 = zext_ln386_fu_260_p1;

assign PermuteData_2_d0 = tmp_16_reg_317;

assign PermuteData_3_address0 = zext_ln386_fu_260_p1;

assign PermuteData_3_d0 = tmp_16_reg_317;

assign PermuteData_address0 = zext_ln386_fu_260_p1;

assign PermuteData_d0 = tmp_16_reg_317;

assign ReadData_1_address0 = zext_ln388_fu_239_p1;

assign ReadData_2_address0 = zext_ln388_fu_239_p1;

assign ReadData_3_address0 = zext_ln388_fu_239_p1;

assign ReadData_address0 = zext_ln388_fu_239_p1;

assign add_ln386_fu_195_p2 = (ap_sig_allocacmp_l_4 + 7'd1);
...
assign empty_fu_206_p1 = ap_sig_allocacmp_l_4[1:0];

assign icmp_ln386_fu_189_p2 = ((ap_sig_allocacmp_l_4 == 7'd64) ? 1'b1 : 1'b0);

assign l_12_cast89_fu_201_p1 = ap_sig_allocacmp_l_4;

assign lshr_ln388_2_fu_229_p4 = {{InputIndex_q0[5:2]}};

assign trunc_ln388_fu_225_p1 = InputIndex_q0[1:0];

assign zext_ln386_fu_260_p1 = lshr_ln386_2_reg_282_pp0_iter2_reg;

assign zext_ln388_fu_239_p1 = lshr_ln388_2_fu_229_p4;

endmodule //Crypto1_Crypto1_Pipeline_VITIS_LOOP_386_724
