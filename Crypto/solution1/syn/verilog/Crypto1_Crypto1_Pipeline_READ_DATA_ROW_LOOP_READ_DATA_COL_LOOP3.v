...
wire   [6:0] select_ln96_2_fu_310_p3;
reg   [6:0] select_ln96_2_reg_451;
wire   [2:0] trunc_ln98_fu_318_p1;
reg   [2:0] trunc_ln98_reg_456;
reg   [2:0] trunc_ln98_5_reg_461;
reg   [2:0] trunc_ln98_5_reg_461_pp0_iter2_reg;
wire   [63:0] zext_ln99_2_fu_369_p1;
reg   [6:0] k_fu_108;
wire   [6:0] add_ln98_1_fu_332_p2;
wire    ap_loop_init;
reg   [6:0] j_fu_112;
reg   [12:0] indvar_flatten47_fu_116;
wire   [12:0] add_ln96_fu_273_p2;
reg   [12:0] ap_sig_allocacmp_indvar_flatten47_load;
wire   [31:0] DataStreamReg_data_fu_381_p19;
...
wire   [0:0] icmp_ln98_fu_296_p2;
wire   [6:0] add_ln96_1_fu_290_p2;
wire   [6:0] select_ln96_fu_302_p3;
wire   [9:0] add_ln99_fu_348_p2;
wire   [9:0] zext_ln99_fu_353_p1;
wire   [9:0] add_ln98_fu_356_p2;
wire   [12:0] tmp_s_fu_362_p3;
wire   [31:0] DataStreamReg_data_fu_381_p17;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [2:0] DataStreamReg_data_fu_381_p1;
wire   [2:0] DataStreamReg_data_fu_381_p3;
wire   [2:0] DataStreamReg_data_fu_381_p5;
wire   [2:0] DataStreamReg_data_fu_381_p7;
wire  signed [2:0] DataStreamReg_data_fu_381_p9;
wire  signed [2:0] DataStreamReg_data_fu_381_p11;
wire  signed [2:0] DataStreamReg_data_fu_381_p13;
wire  signed [2:0] DataStreamReg_data_fu_381_p15;
wire    ap_ce_reg;
...
#0 k_fu_108 = 7'd0;
#0 j_fu_112 = 7'd0;
#0 indvar_flatten47_fu_116 = 13'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln96_fu_267_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten47_fu_116 <= add_ln96_fu_273_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten47_fu_116 <= 13'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln98_5_reg_461 <= {{select_ln96_fu_302_p3[5:3]}};
...
always @ (*) begin
    if (((icmp_ln96_fu_267_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign DataOutStream_TDATA = DataStreamReg_data_fu_381_p19;
...
assign DataRAM_1_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_1_ce0 = DataRAM_1_ce0_local;

assign DataRAM_2_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_2_ce0 = DataRAM_2_ce0_local;

assign DataRAM_3_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_3_ce0 = DataRAM_3_ce0_local;

assign DataRAM_4_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_4_ce0 = DataRAM_4_ce0_local;

assign DataRAM_5_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_5_ce0 = DataRAM_5_ce0_local;

assign DataRAM_6_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_6_ce0 = DataRAM_6_ce0_local;

assign DataRAM_7_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_7_ce0 = DataRAM_7_ce0_local;

assign DataRAM_address0 = zext_ln99_2_fu_369_p1;

assign DataRAM_ce0 = DataRAM_ce0_local;

assign DataStreamReg_data_fu_381_p17 = 'bx;

assign add_ln96_1_fu_290_p2 = (j_fu_112 + 7'd1);

assign add_ln96_fu_273_p2 = (ap_sig_allocacmp_indvar_flatten47_load + 13'd1);

assign add_ln98_1_fu_332_p2 = (select_ln96_fu_302_p3 + 7'd1);

assign add_ln98_fu_356_p2 = (add_ln99_fu_348_p2 + zext_ln99_fu_353_p1);

assign add_ln99_fu_348_p2 = (empty + 10'd64);
...
assign icmp_ln96_fu_267_p2 = ((ap_sig_allocacmp_indvar_flatten47_load == 13'd4096) ? 1'b1 : 1'b0);

assign icmp_ln98_fu_296_p2 = ((k_fu_108 == 7'd64) ? 1'b1 : 1'b0);

assign select_ln96_2_fu_310_p3 = ((icmp_ln98_fu_296_p2[0:0] == 1'b1) ? add_ln96_1_fu_290_p2 : j_fu_112);

assign select_ln96_fu_302_p3 = ((icmp_ln98_fu_296_p2[0:0] == 1'b1) ? 7'd0 : k_fu_108);

assign tmp_s_fu_362_p3 = {{add_ln98_fu_356_p2}, {trunc_ln98_reg_456}};

assign trunc_ln98_fu_318_p1 = select_ln96_fu_302_p3[2:0];

assign zext_ln99_2_fu_369_p1 = tmp_s_fu_362_p3;

assign zext_ln99_fu_353_p1 = select_ln96_2_reg_451;
