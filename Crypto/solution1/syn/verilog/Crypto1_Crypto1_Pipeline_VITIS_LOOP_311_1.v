...
reg   [3:0] lshr_ln2_reg_282;
reg   [3:0] lshr_ln2_reg_282_pp0_iter1_reg;
reg   [3:0] lshr_ln2_reg_282_pp0_iter2_reg;
wire   [1:0] trunc_ln313_fu_225_p1;
reg   [1:0] trunc_ln313_reg_292;
wire   [31:0] tmp_4_fu_247_p6;
reg   [31:0] tmp_4_reg_317;
wire   [63:0] l_3_cast83_fu_201_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln311_fu_189_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln2_reg_282 <= {{ap_sig_allocacmp_l[5:2]}};
    end
end
...
assign l_3_cast83_fu_201_p1 = ap_sig_allocacmp_l;

assign lshr_ln3_fu_229_p4 = {{InputIndex_q0[5:2]}};

assign trunc_ln313_fu_225_p1 = InputIndex_q0[1:0];

assign zext_ln311_fu_260_p1 = lshr_ln2_reg_282_pp0_iter2_reg;

assign zext_ln313_fu_239_p1 = lshr_ln3_fu_229_p4;
