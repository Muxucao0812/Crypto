...
module Crypto1_Crypto1_Pipeline_VITIS_LOOP_386_720 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [3:0] lshr_ln386_1_reg_282;
reg   [3:0] lshr_ln386_1_reg_282_pp0_iter1_reg;
reg   [3:0] lshr_ln386_1_reg_282_pp0_iter2_reg;
wire   [1:0] trunc_ln388_fu_225_p1;
reg   [1:0] trunc_ln388_reg_292;
wire   [31:0] tmp_11_fu_247_p6;
reg   [31:0] tmp_11_reg_317;
wire   [63:0] l_9_cast87_fu_201_p1;
...
wire   [3:0] lshr_ln388_1_fu_229_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln386_fu_189_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln386_1_reg_282 <= {{ap_sig_allocacmp_l_5[5:2]}};
    end
end
...
assign add_ln386_fu_195_p2 = (ap_sig_allocacmp_l_5 + 7'd1);
...
assign empty_fu_206_p1 = ap_sig_allocacmp_l_5[1:0];

assign icmp_ln386_fu_189_p2 = ((ap_sig_allocacmp_l_5 == 7'd64) ? 1'b1 : 1'b0);

assign l_9_cast87_fu_201_p1 = ap_sig_allocacmp_l_5;

assign lshr_ln388_1_fu_229_p4 = {{InputIndex_q0[5:2]}};

assign trunc_ln388_fu_225_p1 = InputIndex_q0[1:0];

assign zext_ln386_fu_260_p1 = lshr_ln386_1_reg_282_pp0_iter2_reg;

assign zext_ln388_fu_239_p1 = lshr_ln388_1_fu_229_p4;

endmodule //Crypto1_Crypto1_Pipeline_VITIS_LOOP_386_720
