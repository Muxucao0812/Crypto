...
reg   [15:0] input1_low_1_reg_599;
reg   [15:0] input1_high_1_reg_604;
wire   [31:0] zext_ln17_1_fu_225_p1;
wire   [31:0] zext_ln18_1_fu_228_p1;
wire   [31:0] zext_ln19_1_fu_231_p1;
wire   [31:0] zext_ln20_1_fu_249_p1;
wire   [31:0] grp_fu_253_p2;
reg   [31:0] temp1_1_reg_633;
reg   [31:0] temp1_1_reg_633_pp0_iter7_reg;
wire   [31:0] grp_fu_259_p2;
reg   [31:0] temp2_1_reg_639;
wire   [31:0] grp_fu_265_p2;
reg   [31:0] temp3_1_reg_645;
wire   [31:0] grp_fu_271_p2;
reg   [31:0] temp4_1_reg_651;
reg   [31:0] temp4_1_reg_651_pp0_iter7_reg;
wire   [15:0] trunc_ln29_fu_277_p1;
reg   [15:0] trunc_ln29_reg_656;
reg   [15:0] trunc_ln29_reg_656_pp0_iter7_reg;
wire   [31:0] add_ln30_3_fu_287_p2;
reg   [31:0] add_ln30_3_reg_661;
wire   [32:0] add_ln30_1_fu_291_p2;
reg   [32:0] add_ln30_1_reg_666;
reg   [15:0] res_mult_shift_part_reg_671;
reg   [15:0] trunc_ln3_reg_677;
...
wire   [15:0] input2_low_1_fu_221_p1;
wire   [3:0] input2_high_1_fu_235_p4;
...
wire   [32:0] zext_ln30_2_fu_281_p1;
wire   [32:0] zext_ln30_3_fu_284_p1;
wire   [48:0] sum2_1_fu_303_p3;
wire   [63:0] zext_ln28_1_fu_310_p1;
wire   [63:0] sum1_1_fu_297_p3;
wire   [47:0] trunc_ln2_fu_320_p3;
wire   [47:0] tmp_fu_314_p3;
wire   [47:0] add_ln74_fu_333_p2;
wire   [63:0] res_mult_shift_fu_327_p2;
wire   [15:0] input2_low_2_fu_370_p1;
wire   [14:0] input2_high_2_fu_384_p4;
...
wire   [62:0] sum1_2_fu_422_p3;
wire   [63:0] zext_ln28_2_fu_428_p1;
wire   [48:0] sum2_2_fu_440_p3;
wire   [63:0] zext_ln28_3_fu_447_p1;
...
wire   [0:0] tmp_2_fu_488_p3;
wire   [31:0] trunc_ln92_1_fu_499_p1;
wire   [31:0] trunc_ln92_2_fu_503_p1;
...
Crypto_mac_muladd_16ns_16ns_32ns_33_4_1 #(
    ...
    .din2_WIDTH( 32 ),
    .dout_WIDTH( 33 ))
mac_muladd_16ns_16ns_32ns_33_4_1_U117(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_523_p0),
    .din1(grp_fu_523_p1),
...
Crypto_mac_muladd_16ns_15ns_32ns_33_4_1 #(
    ...
    .din2_WIDTH( 32 ),
    .dout_WIDTH( 33 ))
mac_muladd_16ns_15ns_32ns_33_4_1_U118(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_531_p0),
    .din1(grp_fu_531_p1),
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        input1_high_1_reg_604 <= {{res_mult_fu_184_p2[61:46]}};
        input1_low_1_reg_599 <= {{res_mult_fu_184_p2[45:30]}};
        ...
        trunc_ln3_reg_677 <= {{res_mult_shift_fu_327_p2[63:48]}};
    end
end

assign add_ln30_1_fu_291_p2 = (zext_ln30_2_fu_281_p1 + zext_ln30_3_fu_284_p1);

assign add_ln30_3_fu_287_p2 = (temp2_1_reg_639 + temp3_1_reg_645);

assign add_ln74_fu_333_p2 = (trunc_ln2_fu_320_p3 + tmp_fu_314_p3);
...
assign ap_return = ((tmp_1_fu_480_p3[0:0] == 1'b1) ? trunc_ln92_fu_496_p1 : select_ln92_fu_507_p3);
...
assign grp_fu_253_p0 = zext_ln17_1_fu_225_p1;

assign grp_fu_253_p1 = zext_ln19_1_fu_231_p1;

assign grp_fu_259_p0 = zext_ln17_1_fu_225_p1;

assign grp_fu_259_p1 = zext_ln20_1_fu_249_p1;

assign grp_fu_265_p0 = zext_ln18_1_fu_228_p1;

assign grp_fu_265_p1 = zext_ln19_1_fu_231_p1;

assign grp_fu_271_p0 = zext_ln18_1_fu_228_p1;

assign grp_fu_271_p1 = zext_ln20_1_fu_249_p1;

assign grp_fu_398_p0 = grp_fu_398_p00;

assign grp_fu_398_p00 = res_mult_shift_part_reg_671;

assign grp_fu_398_p1 = zext_ln19_2_fu_380_p1;

assign grp_fu_410_p0 = zext_ln19_2_fu_380_p1;

assign grp_fu_410_p1 = grp_fu_410_p10;

assign grp_fu_410_p10 = trunc_ln3_reg_677;

assign grp_fu_416_p0 = zext_ln20_2_fu_394_p1;

assign grp_fu_416_p1 = grp_fu_416_p10;

assign grp_fu_416_p10 = trunc_ln3_reg_677;
...
assign grp_fu_531_p1 = zext_ln20_2_fu_394_p1;

assign grp_fu_531_p2 = grp_fu_531_p20;

assign grp_fu_531_p20 = temp3_2_reg_726;

assign input1_high_fu_114_p4 = {{input1_val_int_reg[31:16]}};

assign input1_low_fu_106_p1 = input1_val_int_reg[15:0];

assign input2_high_1_fu_235_p4 = {{m_fu_210_p5[19:16]}};

assign input2_high_2_fu_384_p4 = {{mod_fu_359_p5[30:16]}};

assign input2_high_fu_132_p4 = {{input2_val_int_reg[31:16]}};

assign input2_low_1_fu_221_p1 = m_fu_210_p5[15:0];

assign input2_low_2_fu_370_p1 = mod_fu_359_p5[15:0];

assign input2_low_fu_102_p1 = input2_val_int_reg[15:0];

assign res_mult_fu_184_p2 = (sum1_fu_167_p3 + zext_ln28_fu_180_p1);

assign res_mult_shift_fu_327_p2 = (zext_ln28_1_fu_310_p1 + sum1_1_fu_297_p3);

assign res_shift_fu_435_p2 = (res_mult_reg_594_pp0_iter10_reg - zext_ln28_2_fu_428_p1);

assign select_ln92_fu_507_p3 = ((tmp_2_fu_488_p3[0:0] == 1'b1) ? trunc_ln92_1_fu_499_p1 : trunc_ln92_2_fu_503_p1);

assign sext_ln20_fu_245_p1 = $signed(input2_high_1_fu_235_p4);

assign sub_ln85_fu_451_p2 = (res_shift_reg_741_pp0_iter12_reg - zext_ln28_3_fu_447_p1);
...
assign sum1_1_fu_297_p3 = {{temp4_1_reg_651_pp0_iter7_reg}, {temp1_1_reg_633_pp0_iter7_reg}};

assign sum1_2_fu_422_p3 = {{temp4_2_reg_731}, {temp1_2_reg_721}};

assign sum1_fu_167_p3 = {{temp4_reg_579_pp0_iter3_reg}, {temp1_reg_569_pp0_iter3_reg}};

assign sum2_1_fu_303_p3 = {{add_ln30_1_reg_666}, {16'd0}};

assign sum2_2_fu_440_p3 = {{add_ln30_2_reg_746}, {16'd0}};

assign sum2_fu_173_p3 = {{add_ln30_reg_589}, {16'd0}};

assign tmp_1_fu_480_p3 = sub_ln89_fu_459_p2[32'd63];

assign tmp_2_fu_488_p3 = sub_ln90_fu_475_p2[32'd63];

assign tmp_fu_314_p3 = {{trunc_ln29_reg_656_pp0_iter7_reg}, {temp1_1_reg_633_pp0_iter7_reg}};

assign trunc_ln29_fu_277_p1 = grp_fu_271_p2[15:0];

assign trunc_ln2_fu_320_p3 = {{add_ln30_3_reg_661}, {16'd0}};

assign trunc_ln92_1_fu_499_p1 = sub_ln89_fu_459_p2[31:0];

assign trunc_ln92_2_fu_503_p1 = sub_ln90_fu_475_p2[31:0];

assign trunc_ln92_fu_496_p1 = sub_ln85_reg_751[31:0];

assign zext_ln17_1_fu_225_p1 = input1_low_1_reg_599;

assign zext_ln17_fu_110_p1 = input1_low_fu_106_p1;

assign zext_ln18_1_fu_228_p1 = input1_high_1_reg_604;

assign zext_ln18_fu_124_p1 = input1_high_fu_114_p4;

assign zext_ln19_1_fu_231_p1 = input2_low_1_fu_221_p1;

assign zext_ln19_2_fu_380_p1 = input2_low_2_fu_370_p1;

assign zext_ln19_fu_128_p1 = input2_low_fu_102_p1;

assign zext_ln20_1_fu_249_p1 = $unsigned(sext_ln20_fu_245_p1);

assign zext_ln20_2_fu_394_p1 = input2_high_2_fu_384_p4;

assign zext_ln20_fu_142_p1 = input2_high_fu_132_p4;

assign zext_ln28_1_fu_310_p1 = sum2_1_fu_303_p3;

assign zext_ln28_2_fu_428_p1 = sum1_2_fu_422_p3;

assign zext_ln28_3_fu_447_p1 = sum2_2_fu_440_p3;

assign zext_ln28_fu_180_p1 = sum2_fu_173_p3;

assign zext_ln30_2_fu_281_p1 = temp2_1_reg_639;

assign zext_ln30_3_fu_284_p1 = temp3_1_reg_645;
