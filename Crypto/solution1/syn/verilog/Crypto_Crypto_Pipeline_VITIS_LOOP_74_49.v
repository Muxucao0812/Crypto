...
module Crypto_Crypto_Pipeline_VITIS_LOOP_74_49 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln74_fu_167_p1;
reg   [12:0] j_fu_66;
wire   [12:0] add_ln74_fu_161_p2;
wire    ap_loop_init;
reg   [12:0] ap_sig_allocacmp_j_3;
wire   [31:0] out_data_fu_180_p6;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln74_fu_155_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln74_fu_155_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign DataRAM_10_address0 = zext_ln74_fu_167_p1;

assign DataRAM_1_address0 = zext_ln74_fu_167_p1;

assign DataRAM_4_address0 = zext_ln74_fu_167_p1;

assign DataRAM_7_address0 = zext_ln74_fu_167_p1;

assign add_ln74_fu_161_p2 = (ap_sig_allocacmp_j_3 + 13'd1);
...
assign dataOutStream_TDATA = out_data_fu_180_p6;
...
assign icmp_ln74_fu_155_p2 = ((ap_sig_allocacmp_j_3 == 13'd4096) ? 1'b1 : 1'b0);

assign zext_ln74_fu_167_p1 = ap_sig_allocacmp_j_3;

endmodule //Crypto_Crypto_Pipeline_VITIS_LOOP_74_49
