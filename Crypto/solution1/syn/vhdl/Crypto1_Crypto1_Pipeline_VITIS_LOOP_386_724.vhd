...
entity Crypto1_Crypto1_Pipeline_VITIS_LOOP_386_724 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Crypto1_Crypto1_Pipeline_VITIS_LOOP_386_724 is 
...
attribute shreg_extract : string;
    ...
    signal lshr_ln386_2_reg_282 : STD_LOGIC_VECTOR (3 downto 0);
    signal lshr_ln386_2_reg_282_pp0_iter1_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal lshr_ln386_2_reg_282_pp0_iter2_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal trunc_ln388_fu_225_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln388_reg_292 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_16_fu_247_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_16_reg_317 : STD_LOGIC_VECTOR (31 downto 0);
    signal l_12_cast89_fu_201_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal lshr_ln388_2_fu_229_p4 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    mux_4_2_32_1_1_U169 : component Crypto1_mux_4_2_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln386_fu_189_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                lshr_ln386_2_reg_282 <= ap_sig_allocacmp_l_4(5 downto 2);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    InputIndex_address0 <= l_12_cast89_fu_201_p1(6 - 1 downto 0);
    ...
    PermuteData_1_d0 <= tmp_16_reg_317;
    ...
    PermuteData_2_d0 <= tmp_16_reg_317;
    ...
    PermuteData_3_d0 <= tmp_16_reg_317;
    ...
    add_ln386_fu_195_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_l_4) + unsigned(ap_const_lv7_1));
    ...
    ap_sig_allocacmp_l_4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, l_fu_60, ap_loop_init)
    begin
    ...
    empty_fu_206_p1 <= ap_sig_allocacmp_l_4(2 - 1 downto 0);
    icmp_ln386_fu_189_p2 <= "1" when (ap_sig_allocacmp_l_4 = ap_const_lv7_40) else "0";
    l_12_cast89_fu_201_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_l_4),64));
    lshr_ln388_2_fu_229_p4 <= InputIndex_q0(5 downto 2);
    trunc_ln388_fu_225_p1 <= InputIndex_q0(2 - 1 downto 0);
    zext_ln386_fu_260_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln386_2_reg_282_pp0_iter2_reg),64));
    zext_ln388_fu_239_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln388_2_fu_229_p4),64));
end behav;
